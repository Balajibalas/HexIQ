...
class PersonPage extends StatefulWidget {
  ...
  PersonPage({required this.userId});
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  void _initializeQuiz() {
    QuestionNode q1 = QuestionNode(
      ...
      options: ['Every day', '4-6 times a week', 'Rarely (less than once a week)', 'Never (vegetarian/vegan)'],
      descriptions: [
        'High carbon footprint due to frequent meat consumption.',
        'Significant emissions from regular meat intake.',
        'Moderate carbon impact from reduced meat consumption.',
        'Minimal emissions, plant-based diet.',
      ],
      videoPath: 'assets/videos/video1.mp4',
    );

    QuestionNode q2 = QuestionNode(
      questionText: 'How often do you buy locally produced food?',
      options: ['Always', 'Often', 'Sometimes', 'Never'],
      descriptions: [
        'Low emissions, minimal transportation impact.',
        'Reduced emissions from frequently choosing local foods.',
        'Moderate emissions, mix of local and imported food.',
        'High carbon footprint due to imported products.',
      ],
      videoPath: 'assets/videos/video2.mp4',
    );

    QuestionNode q3 = QuestionNode(
      questionText: 'How fuel-efficient is your vehicle (liters per 100 km or MPG)?',
      options: ['Less than 5 liters/100 km', '5 to 7 liters/100 km', '7 to 10 liters/100 km', 'More than 10 liters/100 km'],
      descriptions: [
        'Very efficient, low emissions.',
        'Moderately efficient, moderate emissions.',
        'Less efficient, higher emissions.',
        'Low efficiency, significant emissions.',
      ],
