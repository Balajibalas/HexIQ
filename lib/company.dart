...
class CompanyPage extends StatefulWidget {
  ...
  CompanyPage({required this.userId});
...
class _CompanyPageState extends State<CompanyPage> {
  ...
  Widget _buildResultSection() {
    ...
    final Map<String, List<double>> _questionValues = {
       'Q1': [5.0, 20.0, 50.0, 100.0],
      'Q2': [5.0, 20.0, 50.0, 100.0],
      'Q3': [10.0, 30.0, 50.0, 100.0],
    };
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  void _initializeQuiz() {
    ...
    questionText: 'How many employees work in your company?',
    options: [
    ...
    descriptions: [
      'Small company, lower overall emissions.',
      'Moderate-sized company, medium carbon footprint.',
      'Larger workforce, increased carbon emissions.',
      'Large company, high emissions from activities.',
    ],
    videoPath: 'assets/videos/video1.mp4',
    );
    QuestionNode q2 = QuestionNode(
    questionText: 'How does your company manage waste?',
    options: [
      'Zero-waste, fully recycled',
      'Mostly recycled',
      'Some recycling, some waste',
      'No recycling, high waste',
    ],
    descriptions: [
      'Almost no waste, low carbon impact.',
      'Moderate waste, reduced emissions from recycling.',
      'Partially responsible, but emissions exist.',
      'High waste generation, significant emissions.',
    ],
    videoPath: 'assets/videos/video2.mp4',
    );

     QuestionNode q3 = QuestionNode(
      questionText: 'How often are company machines maintained or upgraded for efficiency?',
      options: [
        'Regularly maintained, energy-efficient machines',
        'Occasionally maintained, moderately efficient machines',
        'Rarely maintained, outdated machines',
        'Never maintained, old, inefficient machines',
      ],
      descriptions: [
        'Low emissions, high efficiency.',
        'Moderate emissions.',
        'Higher emissions, inefficiency.',
        'Very high emissions from energy wastage.',
      ],
